...
<template>
    <GuestLayout>
        ...
        <div class="text-center mb-6">
            <div class="inline-flex items-center justify-center w-14 h-14 rounded-full mb-4 shadow-lg"
                :class="isFirstUser ? 'bg-gradient-to-br from-amber-500 to-orange-600 shadow-amber-500/25' : 'bg-gradient-to-br from-emerald-500 to-teal-600 shadow-emerald-500/25'">
                <svg v-if="isFirstUser" class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <h1 class="text-2xl font-bold text-white mb-1">
                {{ isFirstUser ? $t('auth.register.admin_title') : $t('auth.register.user_title') }}
            </h1>
            <p class="text-white/60 text-sm">
                {{ isFirstUser ? $t('auth.register.admin_subtitle') : $t('auth.register.user_subtitle') }}
            </p>
        </div>
        ...
        <form @submit.prevent="submit" class="space-y-4">
            ...
            >
                ...
                >
                    ...
                    <span>{{ form.processing ? $t('auth.register.submitting') : $t('auth.register.submit_button') }}</span>
                </div>
            </button>
        </form>
