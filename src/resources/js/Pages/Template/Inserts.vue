            ...
            <div class="min-w-0">
                <div class="mb-4 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        >
                            {{ $t("inserts.system_variables") }}
                        </h2>
                        <p class="text-sm text-slate-500 dark:text-slate-400">
                            {{ $t("inserts.system_variables_desc") }}
                        </p>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    >
                        ...
                        <!-- Variables List -->
                        <div
                            v-show="!collapsedCategories[category.category]"
                            ...
                            >
                                <div class="min-w-0 flex-1">
                                    <div class="flex items-center gap-2">
                                        <code
                                            class="rounded bg-indigo-50 px-2 py-0.5 text-xs font-medium text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-300"
                                        >
                                            {{ variable.code }}
                                        </code>
                                        <span
                    ...
                    >
                        ...
                        >
                            ...
                            <svg
                                class="h-5 w-5 text-slate-400 transition-transform"
                                :class="{
                                    'rotate-180': !collapsedCategories.custom,
                                }"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                        ...
                        <div
                            v-show="!collapsedCategories.custom"
                            class="border-t border-slate-100 dark:border-slate-800"
                        >
                            <div
                            ...
                            >
                                <div class="min-w-0 flex-1">
                                    <div class="flex items-center gap-2">
                                        <code
                                            class="rounded bg-amber-50 px-2 py-0.5 text-xs font-medium text-amber-700 dark:bg-amber-900/30 dark:text-amber-400"
                                        >
                                            [[{{ field.name }}]]
                                        </code>
                                        <span
            ...
            <div class="space-y-8 min-w-0">
                ...
                <div>
                    <div class="mb-4 flex items-center gap-3">
                        ...
                        <div>
                            <h2
                                class="text-lg font-bold text-slate-900 dark:text-white"
                            >
                                {{ $t("inserts.your_inserts") }}
                            </h2>
                            <p
                                class="text-sm text-slate-500 dark:text-slate-400"
                            >
                                {{ $t("inserts.your_inserts_desc") }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        class="rounded-xl border-2 border-dashed border-slate-200 bg-white py-8 text-center dark:border-slate-700 dark:bg-slate-900"
                    >
                        <svg
                        ...
                        >
                            <div class="flex items-start justify-between">
                                <div class="min-w-0 flex-1">
                                    ...
                                    <p
                                        v-if="insert.description"
                                        class="mt-1 text-sm text-slate-500 dark:text-slate-400 break-words"
                                    >
                                        {{ insert.description }}
                                    </p>
                                    <div
                                        v-if="insert.content"
                                        class="mt-2 rounded-lg bg-slate-50 p-2 dark:bg-slate-800"
                                    >
                                        <pre
                                            class="max-h-20 overflow-hidden text-xs text-slate-600 dark:text-slate-400"
                                            >{{
                                                insert.content?.substring(
                                                    0,
                                                    200
                                                )
                                            }}{{
                                                insert.content?.length > 200
                                                    ? "..."
                                                    : ""
                                            }}</pre
                                        >
                            ...
                            <!-- Delete Confirmation -->
                            <div
                                v-if="showDeleteConfirm === insert.id"
                                class="absolute inset-0 flex items-center justify-center bg-slate-900/90 backdrop-blur-sm"
                            >
                                <div class="p-4 text-center">
                                    <p class="mb-3 text-sm text-white">
                                        {{ $t("inserts.confirm_delete") }}
                                    </p>
                ...
                <div>
                    <div class="mb-4 flex items-center gap-3">
                        <div
                            class="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500 to-teal-500"
                        >
                            <svg
                                class="h-5 w-5 text-white"
                                fill="none"
                        ...
                        <div>
                            <h2
                                class="text-lg font-bold text-slate-900 dark:text-white"
                            >
                                {{ $t("inserts.your_signatures") }}
                            </h2>
                            <p
                                class="text-sm text-slate-500 dark:text-slate-400"
                            >
                                {{ $t("inserts.your_signatures_desc") }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div v-else class="space-y-3">
                        ...
                        >
                            <div class="flex items-start justify-between">
                                <div class="min-w-0 flex-1">
                                    ...
                                    <div
                                        ...
                                        class="mt-2 rounded-lg bg-emerald-50 p-2 dark:bg-emerald-900/20"
                                    >
                                        <pre
                                            class="max-h-20 overflow-hidden text-xs text-slate-600 dark:text-slate-400"
                                            >{{
                                                signature.content?.substring(
                                                    0,
                                                    200
                                                )
                                            }}{{
                                                signature.content?.length > 200
                                                    ? "..."
                                                    : ""
                                            }}</pre
                                        >
                                ...
                                <div class="ml-4 flex items-center gap-1">
                                    ...
                                    <button
                                        @click="
                                            showDeleteConfirm = signature.id
                                        "
                                        class="rounded-lg p-2 text-slate-400 transition-colors hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-900/20 dark:hover:text-red-400"
                                        :title="$t('common.delete')"
                                    >
                            ...
                            <!-- Delete Confirmation -->
                            <div
                                v-if="showDeleteConfirm === signature.id"
                                class="absolute inset-0 flex items-center justify-center bg-slate-900/90 backdrop-blur-sm"
                            >
                                <div class="p-4 text-center">
                                    <p class="mb-3 text-sm text-white">
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <button
                            @click="closeModal"
                            class="rounded-lg p-2 text-slate-400 transition-colors hover:bg-slate-100 dark:hover:bg-slate-800"
                        >
                            <svg
                                class="h-5 w-5"
                                fill="none"
                    ...
                    <form @submit.prevent="submitForm" class="p-6">
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    class="w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-900 placeholder-slate-400 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 dark:border-slate-700 dark:bg-slate-800 dark:text-white"
                                    :placeholder="
                                        $t('inserts.description_placeholder')
                                    "
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    :placeholder="
                                        $t('inserts.content_plain_placeholder')
                                    "
                                ></textarea>
                                <p
                                    class="mt-1 text-xs text-slate-500 dark:text-slate-400"
                                >
                                    {{ $t("inserts.content_plain_hint") }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="mt-6 flex items-center justify-end gap-3">
                            ...
                            <button
                                ...
                                :class="
                                    form.type === 'signature'
                                        ? 'from-emerald-600 to-teal-600 shadow-emerald-500/30 hover:from-emerald-500 hover:to-teal-500'
                                        : 'from-indigo-600 to-purple-600 shadow-indigo-500/30 hover:from-indigo-500 hover:to-purple-500'
                                "
