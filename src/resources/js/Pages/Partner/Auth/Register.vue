        ...
        <div class="w-full max-w-lg">
            <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-8">
                <div class="text-center mb-6">
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Join {{ program.name }}</h2>
                    <p class="text-gray-600 dark:text-gray-400 mt-1">Become an affiliate partner</p>
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Website (Optional)</label>
                        <input
                    ...
                    <label class="flex items-start gap-2">
                        ...
                        <span class="text-sm text-gray-600 dark:text-gray-300">
                            I agree to the <a href="#" class="text-indigo-600 hover:underline">terms and conditions</a> of this affiliate program
                        </span>
                    </label>
                ...
                <p class="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <Link :href="route('partner.login', program.slug)" class="text-indigo-600 dark:text-indigo-400 hover:underline font-medium">
                        Sign In
                    </Link>
                </p>
            </div>
