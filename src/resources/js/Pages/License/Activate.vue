        ...
        sections: [
            {
                ...
                items: [t("license.plans.gold.features.core_access")],
            },
            {
            ...
            },
            {
                ...
                items: [t("license.plans.gold.features.team")],
            },
        ],
        summary: [t("license.plans.gold.summary")],
        buttonText: props.stripeGoldPaymentLink
            ? t("license.plans.gold.select")
...
// Manual license status check
const isCheckingStatus = ref(false);
const checkStatusMessage = ref("");
const checkStatusError = ref(false);
...
const checkLicenseStatus = async () => {
    ...
    try {
        ...
        if (data.deactivated) {
            ...
            checkStatusError.value = true;
            checkStatusMessage.value = t("license.status_deactivated");
            setTimeout(() => {
                router.reload();
            }, 2000);
        } else if (data.valid) {
            checkStatusMessage.value = t("license.status_verified");
        } else if (data.has_license && !data.checked) {
            checkStatusError.value = true;
            checkStatusMessage.value =
                data.message || t("license.status_check_failed");
        } else {
            checkStatusError.value = true;
            checkStatusMessage.value =
                data.message || t("license.status_invalid");
        }
    } catch (error) {
        checkStatusError.value = true;
        checkStatusMessage.value = t("license.status_check_error");
    } finally {
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-5xl sm:px-6 lg:px-8">
                ...
                <div
                    v-if="licenseActive && !isGoldExpired"
                    class="mb-8 overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-gray-800"
                >
                    ...
                    <div class="p-6">
                        <div class="mb-6 space-y-4">
                            ...
                            >
                                ...
                                <code
                                    class="block text-sm text-gray-700 dark:text-gray-300 font-mono break-all"
                                    >{{ maskedLicenseKey }}</code
                                >
                            </div>
                        ...
                        >
                            ...
                            <div class="flex items-center gap-3">
                                <button
                                    ...
                                    class="inline-flex items-center gap-2 rounded-lg bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700 transition-all hover:bg-gray-200 disabled:opacity-50 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
                                >
                                    <svg
                                    ...
                                    {{
                                        isCheckingStatus
                                            ? $t("license.checking_status")
                                            : $t("license.check_status")
                                    }}
                                </button>

                                <!-- Status message -->
                                <span
                                    v-if="checkStatusMessage"
                                    :class="[
                                        'text-sm font-medium',
                                        checkStatusError
                        ...
                        <div class="mb-4">
                            <a
                                href="https://netsendo.com/en/legal/eula"
                                target="_blank"
                                class="inline-flex items-center gap-2 text-sm text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300"
                            >
                                <svg
                                    class="h-4 w-4"
                                    fill="none"
                        ...
                        <!-- Upgrade to GOLD option for SILVER users -->
                        <div
                            v-if="licensePlan === 'SILVER'"
                            class="mt-8 overflow-hidden rounded-2xl border border-amber-200 bg-gradient-to-b from-yellow-50 to-white shadow-lg dark:border-amber-900/30 dark:from-yellow-900/10 dark:to-gray-800"
                        >
                            <div
                                class="relative bg-gradient-to-r from-yellow-400 to-amber-600 px-6 py-4 text-white"
                            >
                                <div class="flex items-center justify-between">
                                    ...
                                    <div
                                        class="rounded-full bg-white/20 px-3 py-1 text-xs font-bold uppercase tracking-wider backdrop-blur-sm"
                                    >
                                        Premium
                                    </div>
                                </div>
                            ...
                            <div class="p-6 md:p-8">
                                ...
                                <div class="grid gap-6 md:grid-cols-2">
                                    ...
                                    >
                                        <h5
                                            class="mb-3 font-bold text-amber-700 dark:text-amber-500 uppercase text-xs tracking-wider"
                                        >
                                            {{ section.title }}
                                        </h5>
                                        <ul class="space-y-2">
                                            ...
                                            >
                                                <div
                                                    class="mt-0.5 flex h-4 w-4 flex-shrink-0 items-center justify-center rounded-full text-amber-500"
                                                >
                                                    <svg
                                                        class="h-4 w-4"
                                                        fill="none"
                                ...
                                <div
                                    class="mt-8 flex flex-col items-center justify-between gap-4 rounded-xl border border-amber-100 bg-white p-6 shadow-sm dark:border-amber-900/20 dark:bg-gray-800/50 md:flex-row"
                                >
                                    <div>
                ...
                <div
                    v-if="isGoldExpired"
                    class="mb-8 rounded-xl bg-red-50 p-6 dark:bg-red-900/20"
                >
                    <div class="flex items-center gap-4">
                        <div
                            class="flex h-12 w-12 items-center justify-center rounded-full bg-red-100 dark:bg-red-800"
                        >
                            <svg
                        ...
                        <div>
                            ...
                            >
                                {{ $t("license.gold_expired") }}
                            </h3>
                            <p class="text-red-600 dark:text-red-400">
                                {{
                                    $t("license.gold_expired_desc", {
                ...
                <div v-if="!licenseActive || isGoldExpired">
                    ...
                    <div
                        v-if="successMessage"
                        class="mb-6 rounded-lg bg-green-50 p-4 text-green-700 dark:bg-green-900/30 dark:text-green-400"
                    >
                    ...
                    <div v-if="isPolling" class="mb-8 mx-auto max-w-lg">
                        <div
                            class="overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-gray-800 p-6"
                        >
                            <div class="flex items-center gap-4 mb-4">
                                ...
                                >
                                    <svg
                                        class="h-6 w-6 text-indigo-600 dark:text-indigo-400 animate-spin"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                    >
                                        <circle
                                ...
                                <div>
                                    ...
                                    >
                                        {{
                                            pollingMessage ||
                                            $t("license.waiting_for_activation")
                                        }}
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="mb-10 grid gap-8 md:grid-cols-2">
                        ...
                        >
                            ...
                            <div
                                v-if="plan.popular"
                                class="absolute -right-10 top-6 rotate-45 bg-gradient-to-r from-yellow-400 to-amber-500 px-12 py-1.5 text-xs font-bold text-white shadow"
                            >
                                {{ $t("license.popular") }}
                            </div>
                            ...
                            >
                                <div
                                    class="mb-2 inline-block rounded-full bg-white/20 px-4 py-1 text-sm font-bold backdrop-blur-sm"
                                >
                                    {{ plan.name }}
                                </div>
                            ...
                            <div class="p-6 flex flex-col flex-grow">
                                <div
                                    class="mb-5 text-sm font-medium text-gray-600 dark:text-gray-400 italic"
                                >
                                    {{ plan.description }}
                                </div>
                                ...
                                <div class="flex-grow space-y-6 mb-8">
                                    <div
                                        v-for="(section, idx) in plan.sections"
                                        :key="idx"
                                    >
                                        <h4
                                            class="font-bold text-gray-900 dark:text-white mb-3 text-xs uppercase tracking-wider"
                                            :class="{
                                        ...
                                        <ul class="space-y-3">
                                            ...
                                            >
                                                ...
                                                <span
                                                    class="text-sm text-gray-700 dark:text-gray-300 leading-tight"
                                                    >{{ item }}</span
                                                >
                                            </li>
                                        </ul>
                                ...
                                <div
                                    class="mt-auto mb-6 p-4 rounded-xl bg-gray-50 dark:bg-gray-700/30 border border-gray-100 dark:border-gray-700"
                                >
                                    <p
                    ...
                    <div
                        v-if="showManualInput || requestSent"
                        ...
                        >
                            ...
                            >
                                <div class="mb-4">
                                    ...
                                    ></textarea>
                                    <p
                                        v-if="activateForm.errors.license_key"
