...
function getStatusBadge(status) {
    switch (status) {
        ...
        case 'disabled':
            return { class: 'badge-secondary', label: t('forms.status.disabled') };
        default:
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            <select 
                                ...
                                class="input w-full"
                            >
                                <option value="">{{ t('forms.all_lists') }}</option>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden">
                    <div v-if="forms.data.length === 0" class="p-12 text-center">
                        <div class="mx-auto w-16 h-16 bg-indigo-100 dark:bg-indigo-900/40 rounded-full flex items-center justify-center">
                            ...
                            >
                                ...
                                <td class="px-6 py-4">
                                    <span 
                                        ...
                                        :class="{
                                            'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400': form.status === 'active',
                                            'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400': form.status === 'draft',
                                            'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-400': form.status === 'disabled',
                                        }"
                                    >
                                        {{ getStatusBadge(form.status).label }}
                                    </span>
                                </td>
                                <td class="px-6 py-4 text-center text-gray-900 dark:text-gray-100 font-medium">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end items-center gap-2">
                                        ...
                                        <Link 
                                            :href="route('forms.stats', form.id)"
                                            class="btn-icon"
                    ...
                    <!-- Pagination -->
                    <div v-if="forms.data.length > 0 && forms.last_page > 1" class="px-6 py-4 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex justify-between items-center">
                            <p class="text-sm text-gray-600 dark:text-gray-400">
                                {{ t('common.showing') }} {{ forms.from }}-{{ forms.to }} {{ t('common.of') }} {{ forms.total }}
                            </p>
