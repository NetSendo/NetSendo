...
<template>
    <Head
        :title="`${contact.subscriber?.first_name || ''} ${contact.subscriber?.last_name || contact.subscriber?.email || 'Kontakt'}`"
    />
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        <div
                            class="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-indigo-400 to-purple-500 text-xl font-semibold text-white"
                        >
                            {{
                                (
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button
                        ...
                        class="inline-flex items-center gap-2 rounded-xl bg-amber-100 px-4 py-2 text-sm font-medium text-amber-700 transition hover:bg-amber-200 dark:bg-amber-900/30 dark:text-amber-300"
                    >
                        <svg
                            class="h-4 w-4"
                            fill="none"
            ...
            <div class="space-y-6">
                ...
                >
                    ...
                    <Link
                        ...
                        class="block rounded-xl border border-slate-200 p-4 transition hover:border-indigo-300 dark:border-slate-700 dark:hover:border-indigo-700"
                    >
                        <p class="font-medium text-slate-900 dark:text-white">
                            {{ contact.company.name }}
                        </p>
                        <p
                            v-if="contact.company.industry"
                ...
                <!-- Tags -->
                <div
                    v-if="contact.subscriber?.tags?.length"
                    class="rounded-2xl bg-white p-6 shadow-sm dark:bg-slate-800"
                >
                    <h2
                        class="mb-4 text-lg font-semibold text-slate-900 dark:text-white"
                    ...
                    <div class="flex flex-wrap gap-2">
                        <span
                            v-for="tag in contact.subscriber.tags"
                            :key="tag.id"
                ...
                >
                    ...
                    <div v-if="campaignEvents?.emailLists?.length" class="mb-4">
                        ...
                        <div class="mt-2 flex flex-wrap gap-2">
                            <span
                                v-for="list in campaignEvents.emailLists"
                                :key="list.id"
                    ...
                    <div v-if="campaignEvents?.smsLists?.length" class="mb-4">
                        ...
                        <div class="mt-2 flex flex-wrap gap-2">
                            <span
                                v-for="list in campaignEvents.smsLists"
                                :key="list.id"
                    ...
                    <!-- Email Stats -->
                    <div
                        class="grid grid-cols-2 gap-4 rounded-xl bg-slate-50 p-4 dark:bg-slate-900/50"
                    >
                        <div>
                            <p
                                class="text-2xl font-bold text-slate-900 dark:text-white"
                            >
                                {{ campaignEvents?.stats?.emails_opened || 0 }}
                            </p>
                            <p
                                class="text-sm text-slate-500 dark:text-slate-400"
                            >
                        ...
                        <div>
                            <p
                                class="text-2xl font-bold text-slate-900 dark:text-white"
                            >
                                {{ campaignEvents?.stats?.emails_clicked || 0 }}
                            </p>
                            <p
                                class="text-sm text-slate-500 dark:text-slate-400"
                            >
                ...
                >
                    ...
                    <div class="space-y-4">
                        ...
                        <textarea
                            ...
                            rows="3"
                            placeholder="Dodaj notatkę lub opis aktywności..."
                ...
                >
                    ...
                    >
                        ...
                        <div class="flex items-center gap-2">
                            <button
                                @click="showTaskModal = true"
                                class="rounded-lg p-1.5 text-indigo-600 hover:bg-indigo-50 dark:text-indigo-400 dark:hover:bg-indigo-900/20"
                            >
                                <svg
                                    class="h-5 w-5"
                                    fill="none"
                    ...
                    <div v-else class="py-8 text-center">
                        ...
                        <button
                            @click="showTaskModal = true"
                            class="mt-3 inline-flex items-center gap-2 text-sm font-medium text-indigo-600 hover:text-indigo-700 dark:text-indigo-400"
                        >
                            <svg
                                class="h-4 w-4"
                                fill="none"
