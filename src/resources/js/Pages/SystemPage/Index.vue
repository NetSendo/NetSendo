                    ...
                    <div class="relative w-full sm:w-80">
                        ...
                        >
                            <div class="flex flex-col">
                                ...
                                >
                                    {{ t("system_pages.select_list_hint") }}
                                </span>
                            </div>
                            <svg
                    ...
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        >
                            <div class="flex items-start gap-3">
                                ...
                                >
                                    {{
                                        t("system_pages.global_templates_info")
                                    }}
                                </p>
                            </div>
                        </div>
                                ...
                                >
                                    <tr>
                                        <th scope="col" class="px-6 py-3">
                                            {{ t("system_pages.table.name") }}
                                        </th>
                                        <th scope="col" class="px-6 py-3">
                                            {{ t("system_pages.table.title") }}
                                        </th>
                                        <th scope="col" class="px-6 py-3">
                                            {{ t("system_pages.table.slug") }}
                                        </th>
                                        <th scope="col" class="px-6 py-3">
                                            {{ t("system_pages.table.access") }}
                                        </th>
                                        <th scope="col" class="px-6 py-3">
                                            {{ t("system_pages.table.status") }}
                                        </th>
                                        <th scope="col" class="px-6 py-3">
                                            {{ t("common.actions") }}
                                        </th>
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            >
                                                {{
                                                    page.access === "public"
                                                        ? t(
                                                              "system_pages.access.public",
                                                          )
                                                        : t(
                                                              "system_pages.access.private",
                                                          )
                                                }}
                                            </span>
                                        </td>
                                        <td class="px-6 py-4">
                                            ...
                                            >
                                                {{
                                                    page.is_custom
                                                        ? t(
                                                              "system_pages.customized",
                                                          )
                                                        : t(
                                                              "system_pages.default",
                                                          )
                                                }}
                                            </span>
                                        </td>
