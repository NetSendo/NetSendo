...
const form = useForm({
    ...
    contact_list_id: props.subscriber.contact_list_id,
...
<template>
    <Head :title="`${$t('subscribers.edit_title')}: ${subscriber.email}`" />
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-500 dark:text-slate-400">
                        {{ $t('subscribers.edit_subtitle', { email: subscriber.email }) }}
                    </p>
                </div>
            </div>
        </template>
