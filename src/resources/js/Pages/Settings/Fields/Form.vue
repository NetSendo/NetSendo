...
const submitForm = () => {
    form.transform((data) => ({
        ...data,
        options: ["select", "radio", "checkbox"].includes(data.type)
            ? (data.options || []).filter(
...
const cancelRoute = computed(() => {
    if (props.contactList) {
        return route("mailing-lists.edit", {
            mailing_list: props.contactList.id,
            tab: "fields",
        });
    }
...
<template>
    <Head
        :title="
            isEditing
                ? $t('fields.form.edit_title')
                : $t('fields.form.create_title')
        "
    />
            ...
            <form @submit.prevent="submitForm" class="space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="text"
                                :placeholder="
                                    $t('fields.form.label_placeholder')
                                "
                                ...
                                :class="{
                                    'border-rose-500': form.errors.label,
                                }"
                            />
                            <p
                        ...
                        <div>
                            ...
                            <div class="relative mt-1">
                                ...
                                <input
                                    ...
                                    type="text"
                                    :placeholder="
                                        $t('fields.form.name_placeholder')
                                    "
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows="2"
                                :placeholder="
                                    $t('fields.form.description_placeholder')
                                "
                                class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-slate-600 dark:bg-slate-700 dark:text-white"
                            ></textarea>
                        </div>
                ...
                >
                    ...
                    <div
                        ...
                        class="mt-6 rounded-lg bg-gray-50 p-4 dark:bg-slate-900/50"
                    >
                        <label
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300"
                        >
                        ...
                        <div class="mt-2 space-y-2">
                            ...
                            >
                                <input
                                    ...
                                    type="text"
                                    :placeholder="
                                        $t('fields.form.option_placeholder', {
                                            n: index + 1,
                                        })
                                    "
                    ...
                    <div class="mt-4">
                        ...
                        <input
                            ...
                            type="text"
                            :placeholder="
                                $t('fields.form.default_value_placeholder')
                            "
                            class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-slate-600 dark:bg-slate-700 dark:text-white"
                        />
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <label class="flex items-center gap-3">
                            ...
                            <div>
                                <span
                                    ...
                                    >{{ $t("fields.form.is_public") }}</span
                                >
                                <p
                                    class="text-sm text-gray-500 dark:text-gray-400"
                                >
                                    {{ $t("fields.form.is_public_help") }}
                                </p>
                            </div>
                        </label>
                        ...
                        <label class="flex items-center gap-3">
                            ...
                            <div>
                                <span
                                    class="font-medium text-gray-900 dark:text-white"
                                    >{{ $t("fields.form.is_required") }}</span
                                >
                                <p
                                    class="text-sm text-gray-500 dark:text-gray-400"
                                >
                                    {{ $t("fields.form.is_required_help") }}
                                </p>
                            </div>
                        </label>
                        ...
                        <label class="flex items-center gap-3">
                            ...
                            <div>
                                <span
                                    class="font-medium text-gray-900 dark:text-white"
                                    >{{ $t("fields.form.is_static") }}</span
                                >
                                <p
                                    class="text-sm text-gray-500 dark:text-gray-400"
                                >
                                    {{ $t("fields.form.is_static_help") }}
                                </p>
                            </div>
                        </label>
                    </div>
