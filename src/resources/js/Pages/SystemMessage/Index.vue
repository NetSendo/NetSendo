    ...
    <AuthenticatedLayout>
        <template #header>
            ...
            >
                ...
                <!-- Searchable List Selector with Label -->
                <div class="flex flex-col gap-1">
                    <label
                        class="text-sm font-medium text-gray-600 dark:text-gray-400"
                    >
                        {{ t("settings.system_messages.show_for") }}
                    </label>
                    <div class="relative w-full sm:w-80">
                        <!-- Dropdown trigger button with hint -->
                        <button
                        ...
                        >
                            <div class="flex flex-col">
                                ...
                                >
                                    {{
                                        t(
                                            "settings.system_messages.select_list_hint",
                                        )
                                    }}
                                </span>
                            </div>
                        ...
                        >
                            ...
                            <div class="p-2">
                                <input
                                    ...
                                    :placeholder="
                                        t(
                                            'settings.system_messages.search_list',
                                        )
                                    "
                            ...
                            <ul class="max-h-60 overflow-auto py-1">
                                ...
                                >
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="font-medium">{{
                                            t(
                                                "settings.system_messages.all_lists",
                                            )
                                        }}</span>
                                    </div>
                                </li>
                                ...
                                >
                                    {{
                                        t(
                                            "settings.system_messages.no_lists_found",
                                        )
                                    }}
                                </li>
            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                >
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <div
                            v-if="!currentListId"
                            class="mb-4 rounded-md bg-gray-50 border border-gray-200 p-4 dark:bg-gray-700/50 dark:border-gray-600"
                        >
                            <div class="flex items-start gap-3">
                                ...
                                >
                                    {{
                                        t(
                                            "settings.system_messages.global_templates_info",
                                        )
                                    }}
                                </p>
                            </div>
                        ...
                        <div
                            v-else
                            class="mb-4 rounded-md bg-blue-50 p-4 text-sm text-blue-700 dark:bg-blue-900/50 dark:text-blue-200"
                        >
                            {{
                                t("settings.system_messages.edit_for_list", {
                                    name: lists.find(
                                ...
                                >
                                    <tr>
                                        <th scope="col" class="px-6 py-3">
                                            {{
                                                t(
                                                    "settings.system_messages.table.name",
                                                )
                                            }}
                                        </th>
                                        <th scope="col" class="px-6 py-3">
                                            {{
                                                t(
                                                    "settings.system_messages.table.title",
                                                )
                                            }}
                                        </th>
                                        <th scope="col" class="px-6 py-3">
                                            {{
                                                t(
                                                    "settings.system_messages.table.slug",
                                                )
                                            }}
                                        </th>
                                        <th scope="col" class="px-6 py-3">
                                            {{
                                                t(
                                                    "settings.system_messages.table.status",
                                                )
                                            }}
                                        </th>
                                        <th scope="col" class="px-6 py-3">
                                    ...
                                    >
                                        ...
                                        <td class="px-6 py-4">
                                            {{
                                                message.is_custom
                                                    ? t(
                                                          "settings.system_messages.customized",
                                                      )
                                                    : t(
                                                          "settings.system_messages.default",
                                                      )
                                            }}
                                        </td>
                                        <td class="px-6 py-4">
                                            ...
                                            >
                                                {{
                                                    message.is_custom
                                                        ? t(
                                                              "settings.system_messages.edit",
                                                          )
                                                        : t(
                                                              "settings.system_messages.customize",
                                                          )
                                                }}
                                            </Link>
                                        </td>
