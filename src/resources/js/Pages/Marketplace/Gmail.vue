...
const setupSteps = [
    ...
    },
    {
        ...
        description:
            "Enter Client ID and Client Secret in Settings → Integrations.",
    },
    {
...
<template>
    <Head title="Gmail Integration - NetSendo Marketplace" />
        ...
        <div class="py-8">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <span>/</span>
                    <span class="text-gray-900 dark:text-white">Gmail</span>
                </div>
                ...
                <div class="grid gap-8 lg:grid-cols-3">
                    ...
                    <div class="lg:col-span-2 space-y-8">
                        ...
                        >
                            <div
                                class="bg-gradient-to-r from-red-600/10 to-amber-600/10 dark:from-red-600/20 dark:to-amber-600/20 px-8 py-12"
                            >
                                <div class="flex items-start gap-6">
                                    ...
                                    <div class="pt-2">
                                        ...
                                        >
                                            Connect your Gmail accounts for
                            ...
                            <div class="p-8">
                                ...
                                >
                                    Integrate Gmail with NetSendo to use your
                                    Google email accounts as sending mailboxes.
                                    OAuth 2.0 provides secure authentication
                                    without storing passwords. Send campaigns
                                    directly from your Gmail address for better
                                    deliverability and brand recognition.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div class="space-y-4 mb-8">
                                ...
                                >
                                    <div
                                        class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-red-100 dark:bg-red-500/10 text-sm font-bold text-red-600 dark:text-red-400 ring-1 ring-red-500/20"
                                    >
                                        {{ index + 1 }}
                                    </div>
                                    <div>
                            ...
                            <Link
                                ...
                                class="inline-flex items-center gap-2 rounded-xl bg-red-600 px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-red-500"
                            >
                                <svg
                                    class="h-5 w-5"
                                    fill="none"
                    ...
                    <div class="space-y-6">
                        ...
                        <div
                            class="rounded-2xl bg-gradient-to-br from-red-500/10 to-amber-500/10 p-6 ring-1 ring-red-500/20"
                        >
                            <h3
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                class="inline-flex w-full items-center justify-center rounded-xl bg-red-600 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-red-500"
                            >
                                Documentation
                            </a>
                        </div>
