...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <div>
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400">
                    {{ $t('dashboard.welcome_back', { name: $page.props.auth.user.name }) }}
                </p>
            </div>
        </template>
            ...
            <div class="rounded-xl bg-white p-5 dark:bg-slate-900">
                <div class="flex flex-col items-start gap-4 md:flex-row md:items-center md:justify-between">
                    <div class="flex items-center gap-4">
                        <div class="flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-amber-500 to-orange-500">
        ...
        <div v-if="$page.props.flash?.success" class="mb-6 flex items-center gap-3 rounded-xl bg-emerald-50 p-4 dark:bg-emerald-900/20">
            <svg class="h-5 w-5 text-emerald-600 dark:text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
