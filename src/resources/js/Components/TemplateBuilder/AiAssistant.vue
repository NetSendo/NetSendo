                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                <textarea 
                                    v-model="prompt"
                                    rows="4"
                                    class="w-full rounded-lg border px-3 py-2 text-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 dark:bg-slate-800 dark:text-white"
                                    :class="isListening 
