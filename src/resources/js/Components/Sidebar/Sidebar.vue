...
const updateOpenGroup = () => {
    ...
    if (
        isActive("brain.*") ||
        isActive("brain.index") ||
        isActive("brain.settings")
    ) {
        openGroup.value = "brain";
        return;
    }
...
<template>
    ...
    >
        ...
        >
            ...
            <!-- NetSendo Brain — AI Chat & Settings -->
            <SidebarGroup
                :label="$t('navigation.groups.brain', 'NetSendo Brain')"
                :collapsed="collapsed"
                :is-open="openGroup === 'brain'"
                @toggle="toggleGroup('brain')"
            >
                <template #icon>
                    <svg
                        class="h-5 w-5"
                ...
                >
                    ...
                    <span class="flex items-center gap-2">
                        ...
                        <span
                            class="rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 px-1.5 py-0.5 text-[9px] font-bold text-white"
                            >AI</span
                        >
                    </span>
                </SidebarItem>
                ...
                >
                    ...
                    {{ $t("brain.monitor_label", "Monitor") }}
                </SidebarItem>

                <SidebarItem
                    :href="route('brain.settings')"
                    :active="isActive('brain.settings')"
                    :collapsed="collapsed"
                >
                    <template #icon>
                        <svg
                    ...
                    {{ $t("brain.settings_label", "Ustawienia") }}
                </SidebarItem>

                <SidebarItem
                    :href="route('brain.guide')"
                    :active="isActive('brain.guide')"
                    :collapsed="collapsed"
                >
                    <template #icon>
                        <svg
                    ...
                    {{ $t("brain.guide_label", "Przewodnik") }}
                </SidebarItem>
            </SidebarGroup>
