...
<template>
    <div class="min-h-screen bg-gray-100 dark:bg-slate-900">
        <!-- Top Navbar -->
        <nav
            class="bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700"
        >
                ...
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        <span
                            ...
                            >{{ program?.name || "Partner Portal" }}</span
                        >
                    </div>
        ...
        <div class="flex">
            <!-- Sidebar -->
            <aside
                class="w-64 bg-white dark:bg-slate-800 min-h-[calc(100vh-4rem)] border-r border-gray-200 dark:border-slate-700"
            >
