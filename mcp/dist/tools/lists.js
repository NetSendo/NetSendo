...
export function registerListTools(server, api) {
    // List Contact Lists
    server.tool('list_contact_lists', 'Get all contact lists with subscriber counts. Use this to see available lists for filtering subscribers.', {
    ...
    server.tool('get_contact_list', 'Get detailed information about a specific contact list.', {
