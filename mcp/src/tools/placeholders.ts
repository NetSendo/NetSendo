...
export function registerPlaceholderTools(server: McpServer, api: NetSendoApiClient) {

  // List Placeholders
  server.tool(
    'list_placeholders',
    `Get all available placeholders for personalizing email/SMS content.
...
function getPlaceholderDescription(name: string): string {
